...
export var AdminGamesTable = function () {
    var dispatch = useDispatch();
    var authToken = useSelector(function (state) { return state.authReducer; }).authToken;
    var gameNotClosedError = useSelector(function (state) { return state.dataReducer.planTeamsData; }).gameNotClosedError;
    useLayoutEffect(function () {
        if (authToken) {
            dispatch(getGamesData(authToken));
        }
    }, [authToken, dispatch]);
    var tableHeadTitles = { cell1: 'Game Date', cell2: 'Game Name', cell3: 'Available Players', cell4: 'Register Status' };
    return (React.createElement(Section, null,
        gameNotClosedError && React.createElement(Errors, { errors: gameNotClosedError }),
        React.createElement(Table, null,
            React.createElement(TableHead, null,
                React.createElement(GamesTableHead, __assign({}, tableHeadTitles))),
            React.createElement(TableBody, null,
                React.createElement(AdminTableBody, null)))));
};

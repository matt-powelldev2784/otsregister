...
describe('When the api call is sucessful', function () {
    it('should render 4 rows in the table', function () { return __awaiter(void 0, void 0, void 0, function () {
        var tableRowElements;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, apiCall('get', 'api/games/recentgames', 'dummyAuthToken')];
                case 1:
                    _a.sent();
                    render(React.createElement(Provider, { store: apiSucessStore },
                        React.createElement(UserGamesTable, null)));
                    tableRowElements = screen.getAllByRole('row');
...
describe('When the api call fails', function () {
    it('should render 4 rows in the table', function () { return __awaiter(void 0, void 0, void 0, function () {
        var tableRowElements, noGamesScheduledElement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, apiCall('get', 'api/games/recentgames', 'dummyAuthToken')];
                case 1:
                    ...
                    noGamesScheduledElement = screen.getByText('No Games Scheduled');

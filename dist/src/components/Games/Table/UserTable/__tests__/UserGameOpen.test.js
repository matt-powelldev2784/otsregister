...
describe('player availibility text and toggle should be present', function () {
    it('should render the player availibility text', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            render(React.createElement(Provider, { store: apiSucessStore },
                React.createElement(UserGameOpen, null)));
    ...
    it('should render the toggle button', function () { return __awaiter(void 0, void 0, void 0, function () {
        var toggleInputElement;
        return __generator(this, function (_a) {
            render(React.createElement(Provider, { store: apiSucessStore },
                React.createElement(UserGameOpen, null)));
            toggleInputElement = screen.getByRole('checkbox');
            expect(toggleInputElement.type).toBe('checkbox');
            return [2 /*return*/];
        });
    }); });
    test('toogle should be able to be checked and unchecked', function () { return __awaiter(void 0, void 0, void 0, function () {
        var toggleInputElement;
        return __generator(this, function (_a) {
            render(React.createElement(Provider, { store: apiSucessStore },
                React.createElement(UserGameOpen, null)));
